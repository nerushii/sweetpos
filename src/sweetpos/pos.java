...
public class pos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtprod_id = new javax.swing.JTextField();
        ...
        pro_IDLabel.setText("Product ID:");

        txtprod_id.setFont(new java.awt.Font("Milky Nice", 0, 14)); // NOI18N
        txtprod_id.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtprod_id.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtprod_idKeyPressed(evt);
            }
        });

        pro_NameLabel.setFont(new java.awt.Font("Milky Nice", 0, 24)); // NOI18N
        pro_NameLabel.setForeground(new java.awt.Color(50, 80, 255));
        pro_NameLabel.setText("Product Name:");
        ...
        txtproductname.setFont(new java.awt.Font("Milky Nice", 1, 18)); // NOI18N
        txtproductname.setForeground(new java.awt.Color(0, 0, 0));
        txtproductname.setText("(Enter ID and Press Enter)");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtprod_id, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(pro_IDLabel)
                    .addComponent(txtprod_id, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        endButton.setText("End Transaction");
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addComponent(endButton, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(25, 25, 25))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(32, 32, 32)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        private void pos() {
            String name = txtprod_id.getText();

            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                con1 = DriverManager.getConnection("jdbc:mysql://localhost/sweetdb","root","");
                insert = con1.prepareStatement("select * from products where product_id = ?");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtprod_id.setText(d1.getValueAt(selectIndex, 0).toString());
    ...
    private void sales() {
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/sweetdb","root","");
            String query = "insert into sales(date,username,subtotal,cash,balance)values(?,?,?,?,?)";
            ...
            //Updates the quantity of transacted products in products table
            String query2 = "update products set quantity = quantity - ? where product_id = ?";
            ...
            //Deletes the product if it has 0 quantity
            String query3 = "delete from products where quantity = 0";
    ...
    //Diplays the calculated balance and records data into the database
    ...
    private boolean isQuantityExceeded() {
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            ...
            requestedQuantities.put(product_id, requestedQuantities.getOrDefault(product_id, 0) + requestedQty);
        }
        ...
        for (Map.Entry<String, Integer> entry : requestedQuantities.entrySet()) {
            ...
            try {
                insert = con1.prepareStatement("select quantity from products where product_id = ?");
                ...
                if (rs.next()) {
                    ...
                    if (requestedQty > availableQty) {
                        JOptionPane.showMessageDialog(this, "Not enough stocks on inventory for product ID " + product_id + "!\n" +
                                "Available stocks: " + availableQty + "\n" +
    ...
    //Automatically displays the product name and price when the "Enter" key is pressed while the product id is inputted
    private void txtprod_idKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtprod_idKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                ...
                if (rs.next()==false) {
                    ...
                    txtproductname.setText(product_name.trim());
    ...
    }//GEN-LAST:event_txtprod_idKeyPressed
    ...
    private javax.swing.JTextField txtprod_id;
